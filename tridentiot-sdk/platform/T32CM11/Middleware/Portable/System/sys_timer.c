...
static sys_timer_err_t timer_parameter_check(sys_timer_cmd_t cmd_op,
                                             uint32_t        value)
{
...
static sys_timer_err_t timer_cmd_send(sys_timer_t     *timer,
                                      sys_timer_cmd_t cmd_op,
                                      uint32_t        cmd_value,
                                      uint32_t        is_isr)
{
    sys_timer_err_t t_result = SYS_TIMER_PASS;
...
static void timer_change_period(sys_timer_t *timer,
                                uint32_t    period)
{
    /*-----------------------------------*/
    /* A.Input Parameter Range Check     */
...
static void timer_change_priority(sys_timer_t *timer,
                                  uint32_t    priority)
{
    /*-----------------------------------*/
    /* A.Input Parameter Range Check     */
...
static void timer_change_execute_mode(sys_timer_t *timer,
...
sys_timer_t *sys_timer_create(const char      *name,
                              uint32_t        period,
                              uint32_t        auto_reload,
                              sys_timer_pri_t priority,
                              uint32_t        execute_mode,
                              void            *cb_param,
...
sys_timer_err_t sys_timer_change_period(sys_timer_t *timer,
                                        uint32_t    period)
{
    return SYS_TIMER_CHANGE_PERIOD(timer, period);
}

sys_timer_err_t sys_timer_change_priority(sys_timer_t *timer,
                                          uint32_t    priority)
{
    return SYS_TIMER_CHANGE_PRIORITY(timer, priority);
}

sys_timer_err_t sys_timer_change_execute_mode(sys_timer_t *timer,
                                              uint32_t    execute_mode)
{
...
sys_timer_err_t sys_timer_change_period_from_isr(sys_timer_t *timer,
                                                 uint32_t    period)
{
    return SYS_TIMER_CHANGE_PERIOD_FROM_ISR(timer, period);
}

sys_timer_err_t sys_timer_change_priority_from_isr(sys_timer_t *timer,
                                                   uint32_t    priority)
{
    return SYS_TIMER_CHANGE_PRIORITY_FROM_ISR(timer, priority);
}

sys_timer_err_t sys_timer_change_execute_mode_from_isr(sys_timer_t *timer,
                                                       uint32_t    execute_mode)
{
