 ...
 *
 */
extern uint32_t aes_key_init(struct aes_ctx *ctx,
                             const uint8_t  *key,
                             uint32_t       keybits);
 ...
 *
 */
extern uint32_t aes_ecb_encrypt(struct aes_ctx *ctx,
...
extern uint32_t aes_ecb_decrypt(struct aes_ctx *ctx,
                                const uint8_t  *in_buf,
                                uint8_t        *out_buf);
 ...
 *
 */
extern void aes_xorwith(uint32_t       *result,
                        uint32_t       *buf1,
                        const uint32_t *buf2);
...
extern uint32_t aes_iv_set(struct aes_ctx *ctx,
                           const uint8_t  *iv);
 ...
 *
 */
extern uint32_t aes_iv_get(struct aes_ctx *ctx,
                           uint8_t        *iv);
...
extern uint32_t aes_cbc_buffer_encrypt(struct aes_ctx *ctx,
                                       uint8_t        *in_buf,
                                       uint8_t        *out_buf,
                                       uint32_t       length);
...
extern uint32_t aes_cbc_buffer_decrypt(struct aes_ctx *ctx,
                                       uint8_t        *in_buf,
                                       uint8_t        *out_buf,
                                       uint32_t       length);
