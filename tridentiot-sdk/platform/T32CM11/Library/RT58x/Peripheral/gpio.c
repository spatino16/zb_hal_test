...
// need this for testing the CMSIS app alongside the Rafael HAL library
// gpio_handler is called from assembly
void cmsis_gpio_handler(void);
...
#ifdef CMSIS_TEST_APP
    cmsis_gpio_handler();
#endif //CMSIS_TEST_APP
