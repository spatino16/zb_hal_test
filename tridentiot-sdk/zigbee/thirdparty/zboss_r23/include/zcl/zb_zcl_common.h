...
// Begin Trident Modifications
extern zb_uint8_t         tr_global_default_response_policy;
// End Trident Modifications
...
/** @cond internals_doc */
// Begin Trident Modifications
// Change ZB_ZCL_CONSTRUCT_FRAME_CONTROL() to use the Trident
// global default response policy instead of hardcoding the
...
#define ZB_ZCL_CONSTRUCT_FRAME_CONTROL(                                 \
  ...
  ((  (frame_type)                                                      \
      | ((manuf_specific) << 2)                                         \
      | ((direction) << 3)                                              \
      | ((tr_global_default_response_policy) << 4)))
#if 0
#define ZB_ZCL_CONSTRUCT_FRAME_CONTROL(                                 \
  frame_type, manuf_specific, direction, disable_default_resp)          \
  ((  (frame_type)                                                      \
