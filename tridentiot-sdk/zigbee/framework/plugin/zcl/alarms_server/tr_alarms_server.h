...
/// ***************************************************************************
#ifndef TR_ALARMS_SERVER_H
#define TR_ALARMS_SERVER_H
...
///                                 debug prints
/// ****************************************************************************
#if defined(TR_ALARMS_SERVER_PLUGIN_PRINT_ENABLE) && (TR_ALARMS_SERVER_PLUGIN_PRINT_ENABLE == 1)
#define tr_alarms_server_printf(...)  tr_zcl_printf(__VA_ARGS__)
#define tr_alarms_server_println(...) tr_zcl_println(__VA_ARGS__)
#else
#define tr_alarms_server_printf(...)
#define tr_alarms_server_println(...)
#endif

/// ****************************************************************************
/// @defgroup zcl_alarms_server_cb Alarms Server Callbacks
/// @ingroup zcl_app_callbacks
/// @{
/// ****************************************************************************

/// @brief Callback fires when basic server cluster is initialized
void tr_alarms_server_init_cb(void);

/// @brief Callback that user can declare to handle alarms cluster reset alarm command
